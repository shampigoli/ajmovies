  ...
  return (
    <div>
      <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-8 mx-auto overflow-hidden">
          <div class="flex flex-col text-center w-full mb-4">
            <h1 class="sm:text-3xl text-xl font-medium mt-2 title-font mb-2 text-white">
              Add Movie Of Your Own Choice
            </h1>
          </div>
